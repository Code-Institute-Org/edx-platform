...
from student_enrollment.enrollment_types import (
    ENROLLMENT_TEMPLATE_PARTS, ENROLLMENT_TYPES
)
from ci_program.models import Program
from ci_program.api import (
    get_courses_from_program, get_program_by_program_code)
...
class StudentEnrollment(TimeStampedModel):
    ...
    def enroll(self):
        ...
        Returns True if the student was successfully enrolled in all of the
            modules, otherwise return False
        """
        for course in get_courses_from_program(self.program.program_code):
    ...
    def unenroll(self):
        ...
        Returns True if the student was successfully unenrolled from all of
            the modules, otherwise, return False
        """
