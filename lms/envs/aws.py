...
BREADCRUMB_INDEX_URL = ENV_TOKENS["BREADCRUMB_INDEX_URL"]
...
# HubSpot
HUBSPOT_CONTACTS_ENDPOINT = ENV_TOKENS["HUBSPOT_CONTACTS_ENDPOINT"]

# Zapier
ZAPIER_ENROLLMENT_URL = ENV_TOKENS["ZAPIER_ENROLLMENT_URL"]
ZAPIER_ENROLLMENT_EXCEPTION_URL = ENV_TOKENS["ZAPIER_ENROLLMENT_EXCEPTION_URL"]
ZAPIER_CAREERS_MODULE_ENROLLMENT_URL = ENV_TOKENS["ZAPIER_CAREERS_MODULE_ENROLLMENT_URL"]
ZAPIER_UNENROLLMENT_URL = ENV_TOKENS["ZAPIER_UNENROLLMENT_URL"]
ZAPIER_LOGIN_REMINDER = ENV_TOKENS["ZAPIER_LOGIN_REMINDER"]
ZAPIER_STUDENT_CARE_EMAIL_ENDPOINT = ENV_TOKENS["ZAPIER_STUDENT_CARE_EMAIL_ENDPOINT"]

# Zoho API v2
ZOHO_COQL_ENDPOINT = ENV_TOKENS["ZOHO_COQL_ENDPOINT"]
ZOHO_REFRESH_ENDPOINT = ENV_TOKENS["ZOHO_REFRESH_ENDPOINT"]
ZOHO_MENTORS_ENDPOINT = ENV_TOKENS["ZOHO_MENTORS_ENDPOINT"]
ZOHO_STUDENTS_ENDPOINT = ENV_TOKENS["ZOHO_STUDENTS_ENDPOINT"]
ZOHO_REFRESH_RETRIES = ENV_TOKENS["ZOHO_REFRESH_RETRIES"]
ZOHO_REFRESH_SLEEP_SECS = ENV_TOKENS["ZOHO_REFRESH_SLEEP_SECS"]
LP_ZOHO_CHALLENGE_ENDPOINT = ENV_TOKENS["LP_ZOHO_CHALLENGE_ENDPOINT"]
...
#Set the endpoint, dbname and port for connection to AWS RDS to host lms info
RDS_DB_ENDPOINT = ENV_TOKENS.get("RDS_DB_ENDPOINT")
RDS_DB_PORT = ENV_TOKENS.get("RDS_DB_PORT")
RDS_LMS_DB = ENV_TOKENS.get("RDS_LMS_DB")
LMS_ACTIVITY_TABLE = ENV_TOKENS.get("LMS_ACTIVITY_TABLE")
LMS_SYLLABUS = ENV_TOKENS.get("LMS_SYLLABUS")
...
HUBSPOT_API_KEY = AUTH_TOKENS["HUBSPOT_API_KEY"]

ZOHO_CLIENT_ID = AUTH_TOKENS["ZOHO_CLIENT_ID"]
ZOHO_CLIENT_SECRET = AUTH_TOKENS["ZOHO_CLIENT_SECRET"]
ZOHO_REFRESH_TOKEN = AUTH_TOKENS["ZOHO_REFRESH_TOKEN"]

LP_ZOHO_CLIENT_ID = AUTH_TOKENS["LP_ZOHO_CLIENT_ID"]
LP_ZOHO_CLIENT_SECRET = AUTH_TOKENS["LP_ZOHO_CLIENT_SECRET"]
LP_ZOHO_REFRESH_TOKEN = AUTH_TOKENS["LP_ZOHO_REFRESH_TOKEN"]
