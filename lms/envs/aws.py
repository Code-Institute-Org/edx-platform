...
# MYSQL host and port for LMS Mysql instance
MYSQL_HOST = ENV_TOKENS['MYSQL_HOST']
MYSQL_PORT = ENV_TOKENS['MYSQL_PORT']
MYSQL_DB = ENV_TOKENS['MYSQL_DB']
...
MYSQL_USER = AUTH_TOKENS.get("MYSQL_USER")
MYSQL_PASS = AUTH_TOKENS.get("MYSQL_PASS")
